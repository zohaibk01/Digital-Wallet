...
class MyCards extends StatelessWidget {
  ...
  const MyCards({required this.title});
...
class Wallet extends StatelessWidget {
  ...
  const Wallet({required this.title});
          ...
          AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                ...
                colors: [Colors.blue.shade100, Colors.blue.withOpacity(0)],
              ),
            ),
          ),
          Padding(
